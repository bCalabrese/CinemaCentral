		...
		<form id=searchform>
			...
			<%
				if (request.getParameter("advanced") != null && request.getParameter("advanced") != "false") {
					...
					+"<label for='order'>Order By: </label> "
					+"<select name='order' id='order' class='form-control'> "
					+"<option value='movie.movieTitle' " + ((request.getParameterValues("order") != null && Arrays.asList(request.getParameterValues("order")).contains("movie.movieTitle")) ? "selected" : "") + "> Title</option> "
					+"<option value='movie.movieYearReleased' " + ((request.getParameterValues("order") != null && Arrays.asList(request.getParameterValues("order")).contains("movie.movieYearReleased")) ? "selected" : "") + ">Year</option> "
					+"<option value='movie.movieMPAARating' " + ((request.getParameterValues("order") != null && Arrays.asList(request.getParameterValues("order")).contains("movie.movieMPAARating")) ? "selected" : "") + ">MPAA</option> "
					+"<option value='movie.movieGenre' " + ((request.getParameterValues("order") != null && Arrays.asList(request.getParameterValues("order")).contains("movie.movieGenre")) ? "selected" : "") + ">Genre</option> "
					+"</select> "
					+"</div> "
					+"<input type='hidden' name='advanced' id='secret' value='advanced'>"
					+"</div>");
