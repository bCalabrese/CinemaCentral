...
SELECT * FROM queue
WHERE queue.memberID = 10019
ORDER BY queueSequence;

SELECT movie.movieID, movie.movieGenre, movie.movieTitle, movie.movieDescription, movie.movieYearReleased, movie.movieImage, movie.movieTrailer, 
movie.movieReleaseDate, movie.movieMPAARating 
FROM movie
